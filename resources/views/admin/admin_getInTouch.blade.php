...
@section('title', 'Manage Get In Touch Messages')
    ...
    <div class="card">
        <div class="card-body">
            <table class="table table-bordered table-striped align-middle">
                ...
                <tbody>
                    @forelse($getInTouches as $contact)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.GetInTouch.destroy', $contact->id) }}"
                                      method="POST"
                                      class="d-inline">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center">
                                No Get In Touch messages found.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
