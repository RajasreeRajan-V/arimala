...
<head>
    <meta charset="UTF-8">
    <title>Login | Arimala Hospital</title>
...
<body class="min-h-screen bg-gradient-to-br from-[#e6f2f6] to-[#f4f9fb] flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl p-10 border border-gray-100">
        ...
        <div class="flex justify-center mb-6">
            <img src="img/back-logo.png" alt="Arimala Hospital Logo" class="h-20">
        </div>
        ...
        <!-- Login Form -->
        <form method="POST" action="{{ route('admin.do.login') }}" class="space-y-5">
            @csrf
            ...
            <div class="flex items-center justify-between text-sm">
                <label class="flex items-center text-gray-600">
                    <input type="checkbox" name="remember"
                           class="mr-2 accent-[var(--accent-color)]">
                    Remember me
                </label>
