            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li><a href="{{ route('career') }}" class="active">Career</a></li>
                        ...
                        @empty
                            <div class="col-12 text-center py-5">
                                <div style="padding: 40px; border-radius: 12px; background: #f4f9f9;">
                                    <i class="bi bi-briefcase" style="font-size: 40px; color: #107A7C;"></i>
                                    ...
                                    <p style="color: #6c757d;">
                                        Currently, there are no vacancies. Please check back later.
                                    </p>
                                </div>
                            </div>
                        @endforelse
