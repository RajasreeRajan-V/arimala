...
<body class="departments-page">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li class="dropdown"><a href="#"><span>Departments</span> <i
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('departments') }}" class="dropdown-dept-link active">
    ...
    <main class="main">
                            ...
                            <div class="tab-content department-content">
                                ...
                                @foreach ($departments as $key => $department)
                                    <div class="tab-pane fade {{ $key == 0 ? 'show active' : '' }}"
                                        id="department-{{ $department->id }}" role="tabpanel">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="service-item d-flex">
                                                                    ...
                                                                    <div class="service-content">
                                                                        ...
                                                                        <p>{{ $department->subtagline1_description }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="service-item d-flex">
                                                                    ...
                                                                    <div class="service-content">
                                                                        ...
                                                                        <p>{{ $department->subtagline2_description }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="service-item d-flex">
                                                                    ...
                                                                    <div class="service-content">
                                                                        ...
                                                                        <p>{{ $department->subtagline3_description }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="service-item d-flex">
                                                                    ...
                                                                    <div class="service-content">
                                                                        ...
                                                                        <p>{{ $department->subtagline4_description }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <!-- Departments Section -->
        <section id="departments" class="departments section"  style="
    position: relative;
    background-image:
